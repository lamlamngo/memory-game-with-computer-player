...
/**
 * Class that extends JButton, enabling us to change the color of a button when we hover over it.
 * @author Lam Ngo
 * @version 02/22/2017
 */
public class CustomButton extends JButton {
        private Color hoverBackgroundColor = Color.yellow; // when the button is hovered over
        private Color pressedBackgroundColor = Color.red; // when the button is clicked  on
